					...
					<div class="row sales-cards">
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card color-info bg-primary mb-4">
								...
								<h3 class="counters" data-count="10000">10,000</h3>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card color-info bg-secondary mb-4">
								...
								<h3 class="counters" data-count="800">800</h3>
										...
										<table class="table table-borderless recent-transactions">
											...
											<tbody>
												<tr>
													...
													<td>
														<span class="d-block head-text">Transfer</span>
														<span class="text-blue">Reference56</span>
													</td>
													<td>Success</td>
													<td>&#8358;1,099.00</td>
												</tr>
